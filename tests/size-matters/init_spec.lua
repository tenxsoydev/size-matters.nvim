...
describe("Test size-matters.nvim", function()
	...
	it("can increase the guifont's size", function()
		...
		sm.update_font "grow"
		assert.equals("SomeNerdFont:h14", vim.api.nvim_get_option "guifont")
	end)

	it("can decrease the guifont's size", function()
		-- test default
		sm.update_font "shrink"
		assert.equals("SomeNerdFont:h11.5", vim.api.nvim_get_option "guifont")

		-- test custom
		sm.setup { step_size = 1.5 }
		sm.update_font "shrink"
		assert.equals("SomeNerdFont:h10", vim.api.nvim_get_option "guifont")
	end)
	...
	it("can reset the guifont", function()
		...
		sm.update_font "grow"
		sm.reset_font()
		assert.equals("SomeNerdFont:h12.5", vim.api.nvim_get_option "guifont")
